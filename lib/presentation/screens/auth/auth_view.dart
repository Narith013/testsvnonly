...
class AuthViewImpl implements AuthView {
  ...
  Widget emailTextField() => new Container(
        ...
        child: new TextField(
          ...
          decoration: new InputDecoration.collapsed(
              hintText: "Email", fillColor: Colors.transparent, filled: true),
    ...
    return new Center(
      child: new Column(
        ...
        children: <Widget>[
          emailTextField(),
          passwordTextField(),
          properties.signState == SignState.SIGNUP
  ...
  Widget confirmButton(VoidCallback callback) => new Padding(
  ...
  Widget confirmPassTextField() => new Container(
        ...
        child: new TextField(
          ...
          decoration:
              new InputDecoration.collapsed(hintText: "Confirm password"),
        ),
      );
